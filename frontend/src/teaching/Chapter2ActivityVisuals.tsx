...
function Extension2B(){return <div className="h2av-shell"><SourceTag>EXTENSION ACTIVITY 2B</SourceTag><div className="h2av-equation"><strong>f = c / λ</strong><span>c = 3 × 10⁸ m/s</span></div><div className="h2av-spectrum"><span>radio waves</span><i>→</i><span>microwaves</span><i>→</i><span>infrared</span></div><p className="h2av-prompt">Confirm the frequency values in Table 2.3 using the wavelengths given.</p></div>}
