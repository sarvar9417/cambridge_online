 ...
 * - TCP/IP, HTTP, BitTorrent process and router-decision scenes use large benchmark-style hero visuals.
 * - BitTorrent terminology keeps the richer source-exact swarm terminology diagram from V4.
