...
export function hasChapter14PresentationVisualV4(beat:LessonPresentationBeat){
  return hasChapter14PresentationVisualV6(beat)||hasChapter13PresentationVisual(beat)||hasChapter2InternetVisual(beat)||hasChapter2PresentationVisual(beat)||hasChapter1PresentationVisual(beat);
}
