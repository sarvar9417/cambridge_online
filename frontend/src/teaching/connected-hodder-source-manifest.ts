...
/**
 * Exact connected-source locks for full Hodder books rather than chapter-only
 * extracts. Page fingerprints use the same invariant as the extract manifests:
 * SHA-256 over a whitespace-normalised text layer. The physical-page range is
 * recorded explicitly so printed textbook numbering cannot be confused with
 * PDF page numbering.
 */
export const CHAPTER_3_CONNECTED_HODDER_SOURCE: ConnectedHodderSourceManifest = {
  syllabus: '9618',
  chapter: 3,
...
export const CONNECTED_HODDER_SOURCE_MANIFESTS = [CHAPTER_3_CONNECTED_HODDER_SOURCE] as const;
