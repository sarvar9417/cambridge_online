...
describe('Chapter 14 final page-by-page live source audit',()=>{
  ...
  it('routes live Chapter 14 through the registry fallback and loads final CSS after deep layers',()=>{
    ...
    expect(styles).toContain("./chapter14-presentation-final-source.css");
    expect(styles.indexOf("./chapter14-presentation-deep-audit.css")).toBeLessThan(styles.indexOf("./chapter14-presentation-final-source.css"));
    expect(styles.indexOf("./chapter14-presentation-deep-content.css")).toBeLessThan(styles.indexOf("./chapter14-presentation-final-source.css"));
  });
