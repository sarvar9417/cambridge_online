...
const TOPIC_12:AuthoredSceneSpec[]=[
  ...
  s({id:'h1p-bitmap-resolution-compare',slideId:'h1-bitmap-resolution',role:'compare',eyebrow:'BITMAP QUALITY · COMPARE',lead:true,block:{index:0},keyTerms:[4]}),
