...
const chapter7BookWithCheckpoints = withChapter7PastPaperCheckpoints(CHAPTER_7_FINAL_SOURCE_SLIDES);
...
export const CHAPTER_7_BOOK_START_ID = CHAPTER_7_FINAL_SOURCE_SLIDES[0]?.id ?? '';
