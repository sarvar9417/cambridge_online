...
const currentTargetSlide=(slide:HodderLessonSlide):HodderLessonSlide=>{
  ...
  return {
    ...
    lead:'Work through approved Cambridge 9618 questions for this current learning objective. 2021–2025 questions appear only through explicit equivalent/subtopic-compatible syllabus mappings; verified 2026 questions are matched directly to the current target.',
    ...
    sourceElements:[
      ...
      'Current 2026–2028 LO target → explicit compatibility graph → approved 2021–2026 QP leaves',
    ],
  };
};
...
export const applyCurrent9618CheckpointTargets=(chapter:HodderLessonChapter):HodderLessonChapter=>({
  ...chapter,
  coverage:`${chapter.coverage} · live checkpoints target current 2026–2028 LOs and approved 2021–2026 papers`,
