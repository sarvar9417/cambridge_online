 ...
 * fragments, activities, figures, tables, review items and exam-style question
 * identifiers are attached to the presenter route rather than being represented
 * only by a page-level summary.
 */
