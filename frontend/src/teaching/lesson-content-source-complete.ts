import { SOURCE_ATOM_COMPLETE_CHAPTER_1, SOURCE_ATOM_COMPLETE_CHAPTER_13 } from './lesson-content-source-atom-complete';
...
export const LESSON_CHAPTERS = [SOURCE_ATOM_COMPLETE_CHAPTER_1, SOURCE_ATOM_COMPLETE_CHAPTER_13];
