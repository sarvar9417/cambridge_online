...
export const CHAPTER_14_MASTER_SOURCE_MAP:Chapter14SourceItem[]=[
  {id:'objectives',pages:[328],kind:'objective',label:'Chapter learning objectives',anchors:['need for protocols','implementation of protocols such as a stack','four layers','HTTP','FTP','POP3/4','IMAP','SMTP','BitTorrent','circuit switching','packet switching','router']},
  ...
  {id:'terms-141',pages:[329],kind:'term',label:'14.1 key terms',anchors:['Protocol','HTTP','Packet','Segment','FTP','SMTP','Push protocol','Binary file','MIME','POP','IMAP','TCP','Pull protocol','Host-to-host','Host','BitTorrent','Peer','Metadata','Pieces','Tracker','Swarm','Seed','Leech','Lurker']},
  ...
  {id:'fig-14-1',pages:[329,330],kind:'figure',label:'Figure 14.1 TCP/IP stack',anchors:['APPLICATION LAYER','TRANSPORT LAYER','INTERNET (NETWORK) LAYER','LINK NETWORK','Sending','Receiving','decomposition','implemented using software']},
  ...
  {id:'http-sequence',pages:[331],kind:'concept',label:'HTTP request sequence',anchors:['client/server protocol','request messages','format of the messages','URL','port 80','DNS server','acknowledgement','HTML format','media player']},
  ...
  {id:'transport-tcp',pages:[333,334],kind:'concept',label:'Transport layer and TCP/PAR',anchors:['TCP','UDP','SCTP','positive acknowledgement with re-transmission','connection-orientated','host-to-host','synchronisation sequence bits']},
  ...
  {id:'wireless',pages:[335],kind:'concept',label:'Wireless protocols',anchors:['IEEE 802.11','CSMA/CA','DCF','acknowledgement','random wait','IEEE 802.15','IEEE 802.16','802.16-2004','802.16-2005']},
  ...
  {id:'fig-14-7',pages:[338],kind:'figure',label:'Figure 14.7 circuit route',anchors:['A–R2','R2–R5','R5–R8','R8–R7','R7–R10','R10–B','provided B is not busy','public telephone networks','private telephone networks','private data networks']},
  ...
  {id:'fig-14-9-header',pages:[341],kind:'figure',label:'Figure 14.9 packet header',anchors:['source computer','destination computer','current hop number','length of packet','number of packets','sequence number','checksum value','protocol version','header length','priority','DF','MF','fragmentation offset','TCP, UDP','6 × 4 = 24bytes']},
  {id:'routing-table',pages:[341,342],kind:'concept',label:'Routing tables and Figure 14.10',anchors:['number of hops','MAC address of the next router','metrics','network destination','gateway','netmask','interface','shortest/best route','no route can be found','hop number = 0']},
  ...
  {id:'eoc',pages:[344,345],kind:'exam',label:'End-of-chapter questions 1–4',anchors:['Question 1','Question 2','Question 3','Question 4','peer-to-peer terms','TCP/IP protocol layers','sending and receiving emails','Ethernet data','metadata','BitTorrent protocol','circuit switching','video conferencing','web page','dedicated circuit/path','bandwidth is shared','correct order','hop number/hopping','checksum','headers and routing tables']},
];
