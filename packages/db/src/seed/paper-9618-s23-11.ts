        ...
        children: [
          {
            ...
            label: 'i',
            stemLatex:
              'Explain the reasons why compressing the photographs will benefit the customers.',
            command: 'Explain',
            marks: 3,
            ao: 'AO1',
            answerLines: 6,
        ...
        children: [
          {
            ...
            scheme: allRequired(
              [
                'Foreign key: BirdID — table: BIRD_SEEN',
                'Foreign key: PersonID — table: BIRD_SEEN',
              ],
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            subtopics: ['1.1'],
            scheme: allRequired(
              ['Working: 10110000 + 00011011', 'Answer: 11001011'],
              '1 mark for working; 1 mark for answer',
            ),
          },
          {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: 'ii',
            stemLatex:
              'The network makes use of subnetting. Describe two benefits of subnetting a network.',
            command: 'Describe',
            marks: 4,
            ao: 'AO1',
            answerLines: 8,
    ...
    children: [
      {
        ...
        subtopics: ['3.2'],
        scheme: allRequired(
          ['1 mark for 2 gates drawn correctly', '2 marks for all 4 gates drawn correctly'],
