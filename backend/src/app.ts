...
import { LiveChallengeModerationService } from './services/live-challenge-moderation-service.js';
import { LiveChallengeTimingService } from './services/live-challenge-timing-service.js';
...
export function createApp(
  ...
  if (pool) mountPrivate('/api/v1/live-challenges', createLiveChallengesRouter(
    ...
    new LiveChallengeModerationService(pool),
    new LiveChallengeTimingService(pool),
  ));
