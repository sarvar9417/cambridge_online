...
export function createApp(
  ...
  if (pool) mountPrivate('/api/v1/live-challenges', createLiveChallengesRouter(new LiveChallengeService(pool),new LiveChallengeSessionService(pool,assetUrlSigner)));
