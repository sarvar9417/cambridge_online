-- 0184_9618_2026_mj32_taxonomy_closure.sql
-- Source-backed taxonomy closure for Cambridge 9618/32/M/J/26.
-- QP SHA256: b8977524b1dba38869c69e6290a3647d644f7a4ae450f7ae5eff29fe569751fb
-- MS SHA256: 711360ab6d0a366f9cb2d5143695c106a3a4879b7f41d97773be5223c059aa4d
-- Official syllabus: Cambridge 9618 syllabus for 2026, Drive 1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw
--
-- All 26 approved scoring leaves are manually adjudicated against the QP,
-- published MS and official 2026 syllabus. Q10(b) is moved from Algorithms
-- to File Processing (20.2): it directly requires OPENFILE/SEEK/GETRECORD/
-- CLOSEFILE pseudocode, matching the source-reviewed 2025 corpus precedent.
...
BEGIN
  ...
  JOIN public.source_papers qp ON qp.syllabus_id=sy.id AND qp.component_id=c.id
    ...
    AND qp.sha256='b8977524b1dba38869c69e6290a3647d644f7a4ae450f7ae5eff29fe569751fb'
  ...
  JOIN public.source_papers ms ON ms.syllabus_id=sy.id AND ms.component_id=c.id
    ...
    AND ms.sha256='711360ab6d0a366f9cb2d5143695c106a3a4879b7f41d97773be5223c059aa4d'
  ...
  IF v_qp IS NULL OR v_ms IS NULL THEN
    RAISE EXCEPTION '0184 exact 9618/32/M/J/26 QP/MS source gate failed';
  END IF;
  ...
  IF v_leaves<>26 OR v_edges<>26 THEN
    RAISE EXCEPTION '0184 precondition failed leaves=% edges=% expected=26/26',v_leaves,v_edges;
  END IF;
END $$;
...
WITH paper AS (
  ...
  VALUES
    ('9618/32/M/J/26 Q1(a)','13.1'),('9618/32/M/J/26 Q1(b)(i)','13.1'),('9618/32/M/J/26 Q1(b)(ii)','13.1'),
    ('9618/32/M/J/26 Q2','14.1'),
    ('9618/32/M/J/26 Q3(a)','13.3'),('9618/32/M/J/26 Q3(b)','13.3'),
    ('9618/32/M/J/26 Q4(a)','13.2'),('9618/32/M/J/26 Q4(b)','13.2'),('9618/32/M/J/26 Q4(c)','13.2'),
    ('9618/32/M/J/26 Q5','15.1'),
    ('9618/32/M/J/26 Q6(a)','16.2'),('9618/32/M/J/26 Q6(b)','16.2'),('9618/32/M/J/26 Q6(c)','16.2'),
    ('9618/32/M/J/26 Q7(a)(i)','15.2'),('9618/32/M/J/26 Q7(a)(ii)','15.2'),
    ('9618/32/M/J/26 Q7(a)(iii)','15.2'),('9618/32/M/J/26 Q7(b)','15.2'),
    ('9618/32/M/J/26 Q8(a)','17.1'),('9618/32/M/J/26 Q8(b)','17.1'),
    ('9618/32/M/J/26 Q9(a)','18.1'),('9618/32/M/J/26 Q9(b)(i)','18.1'),('9618/32/M/J/26 Q9(b)(ii)','18.1'),
    ('9618/32/M/J/26 Q10(a)','19.1'),('9618/32/M/J/26 Q10(b)','20.2'),
    ('9618/32/M/J/26 Q11(a)','20.1'),('9618/32/M/J/26 Q11(b)','20.1')
), tl(display_ref,lo_code) AS (
  VALUES
    ('9618/32/M/J/26 Q1(a)','13.1.2'),('9618/32/M/J/26 Q1(b)(i)','13.1.2'),('9618/32/M/J/26 Q1(b)(ii)','13.1.2'),
    ('9618/32/M/J/26 Q2','14.1.2'),('9618/32/M/J/26 Q2','14.1.3'),
    ('9618/32/M/J/26 Q3(a)','13.3.2'),('9618/32/M/J/26 Q3(b)','13.3.4'),
    ('9618/32/M/J/26 Q4(a)','13.2.1'),('9618/32/M/J/26 Q4(b)','13.2.1'),('9618/32/M/J/26 Q4(c)','13.2.2'),
    ('9618/32/M/J/26 Q5','15.1.5'),
    ('9618/32/M/J/26 Q6(a)','16.2.4'),('9618/32/M/J/26 Q6(b)','16.2.4'),('9618/32/M/J/26 Q6(c)','16.2.4'),
    ('9618/32/M/J/26 Q7(a)(i)','15.2.8'),('9618/32/M/J/26 Q7(a)(ii)','15.2.8'),
    ('9618/32/M/J/26 Q7(a)(iii)','15.2.8'),
    ('9618/32/M/J/26 Q7(b)','15.2.5'),('9618/32/M/J/26 Q7(b)','15.2.6'),
    ('9618/32/M/J/26 Q8(a)','17.1.1'),('9618/32/M/J/26 Q8(b)','17.1.1'),
    ('9618/32/M/J/26 Q9(a)','18.1.3'),('9618/32/M/J/26 Q9(b)(i)','18.1.1'),('9618/32/M/J/26 Q9(b)(ii)','18.1.1'),
    ('9618/32/M/J/26 Q10(a)','19.1.1'),('9618/32/M/J/26 Q10(a)','19.1.5'),
    ('9618/32/M/J/26 Q10(b)','20.2.1'),
    ('9618/32/M/J/26 Q11(a)','20.1.1'),('9618/32/M/J/26 Q11(b)','20.1.1')
), state AS (
  SELECT q.id question_id,q.source_paper_id,q.status::text old_status,q.stem_md,
         ...
         new_st.id new_primary_id,tp.new_primary,p.syllabus_id,p.qp_sha,p.qp_url,p.ms_sha,p.ms_url
...
SELECT question_id,source_paper_id,'manual-source-audit-0184-2026-mj32',
  ...
  jsonb_build_object(
    ...
    'qp_filename','9618_s26_qp_32.pdf','qp_sha256',qp_sha,'qp_source_url',qp_url,
    'ms_filename','9618_s26_ms_32.pdf','ms_sha256',ms_sha,'ms_source_url',ms_url,
    'syllabus_source_url','https://drive.google.com/file/d/1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw/view',
    'precedent','2025 reviewed random-file code maps to 20.2.1'
  )
FROM final_state s
WHERE NOT EXISTS (
  SELECT 1 FROM public.question_taxonomy_review_history h
  WHERE h.question_id=s.question_id AND h.review_tag='manual-source-audit-0184-2026-mj32'
);

-- Replace classifier LO output with 29 source-reviewed objective edges.
WITH p AS (
...
WITH tl(display_ref,lo_code) AS (
  VALUES
    ...
    ('9618/32/M/J/26 Q5','15.1.5'),
    ('9618/32/M/J/26 Q6(a)','16.2.4'),('9618/32/M/J/26 Q6(b)','16.2.4'),('9618/32/M/J/26 Q6(c)','16.2.4'),
    ('9618/32/M/J/26 Q7(a)(i)','15.2.8'),('9618/32/M/J/26 Q7(a)(ii)','15.2.8'),('9618/32/M/J/26 Q7(a)(iii)','15.2.8'),
    ('9618/32/M/J/26 Q7(b)','15.2.5'),('9618/32/M/J/26 Q7(b)','15.2.6'),
    ('9618/32/M/J/26 Q8(a)','17.1.1'),('9618/32/M/J/26 Q8(b)','17.1.1'),
    ('9618/32/M/J/26 Q9(a)','18.1.3'),('9618/32/M/J/26 Q9(b)(i)','18.1.1'),('9618/32/M/J/26 Q9(b)(ii)','18.1.1'),
    ('9618/32/M/J/26 Q10(a)','19.1.1'),('9618/32/M/J/26 Q10(a)','19.1.5'),
...
-- Rebuild primary subtopics to reviewed targets.
WITH p AS (
  SELECT qp.id FROM public.source_papers qp
  JOIN public.syllabi sy ON sy.id=qp.syllabus_id
  JOIN public.components c ON c.id=qp.component_id
...
WITH tp(display_ref,new_primary) AS (
  VALUES
    ('9618/32/M/J/26 Q1(a)','13.1'),('9618/32/M/J/26 Q1(b)(i)','13.1'),('9618/32/M/J/26 Q1(b)(ii)','13.1'),
    ('9618/32/M/J/26 Q2','14.1'),('9618/32/M/J/26 Q3(a)','13.3'),('9618/32/M/J/26 Q3(b)','13.3'),
    ('9618/32/M/J/26 Q4(a)','13.2'),('9618/32/M/J/26 Q4(b)','13.2'),('9618/32/M/J/26 Q4(c)','13.2'),
    ('9618/32/M/J/26 Q5','15.1'),('9618/32/M/J/26 Q6(a)','16.2'),('9618/32/M/J/26 Q6(b)','16.2'),
    ('9618/32/M/J/26 Q6(c)','16.2'),('9618/32/M/J/26 Q7(a)(i)','15.2'),('9618/32/M/J/26 Q7(a)(ii)','15.2'),
    ('9618/32/M/J/26 Q7(a)(iii)','15.2'),('9618/32/M/J/26 Q7(b)','15.2'),
    ('9618/32/M/J/26 Q8(a)','17.1'),('9618/32/M/J/26 Q8(b)','17.1'),
    ('9618/32/M/J/26 Q9(a)','18.1'),('9618/32/M/J/26 Q9(b)(i)','18.1'),('9618/32/M/J/26 Q9(b)(ii)','18.1'),
    ('9618/32/M/J/26 Q10(a)','19.1'),('9618/32/M/J/26 Q10(b)','20.2'),
...
SELECT question_id,subtopic_id,true,1.0,1.0,'manual-source-audit-0184' FROM r
ON CONFLICT(question_id,subtopic_id)
DO UPDATE SET is_primary=true,weight=1.0,confidence=1.0,set_by='manual-source-audit-0184';

DO $$
DECLARE v_qp uuid; v_history int; v_edges int; v_primary int; v_low_p int; v_low_lo int; v_q10b int;
BEGIN
  ...
  WHERE q.source_paper_id=v_qp AND h.review_tag='manual-source-audit-0184-2026-mj32';
  ...
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/32/M/J/26 Q10(b)'
    AND st.code='20.2' AND lo.code='20.2.1';

  IF v_history<>26 OR v_edges<>29 OR v_primary<>26 OR v_low_p<>0 OR v_low_lo<>0 OR v_q10b<>1 THEN
    RAISE EXCEPTION '0184 closure failed history=% edges=% primary=% low_primary=% low_lo=% q10b=%',
      v_history,v_edges,v_primary,v_low_p,v_low_lo,v_q10b;
  END IF;
END $$;
