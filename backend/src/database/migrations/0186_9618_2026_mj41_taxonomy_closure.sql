-- 0186_9618_2026_mj41_taxonomy_closure.sql
-- Source-backed taxonomy closure for Cambridge 9618/41/M/J/26.
-- QP SHA256: da482500bff5415dac950a5ed127eeb8ec760bb738da4c146d08b73ef057ec4b
-- MS SHA256: 16b8a6e3a0db965cf92180095778335e3d71b38421608cf2345bd7ae729db365
-- Official syllabus: Cambridge 9618 syllabus for 2026, Drive 1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw
--
-- All 23 approved scoring leaves are manually adjudicated against the QP,
...
BEGIN
  ...
  JOIN public.source_papers qp ON qp.syllabus_id=sy.id AND qp.component_id=c.id
    ...
    AND qp.sha256='da482500bff5415dac950a5ed127eeb8ec760bb738da4c146d08b73ef057ec4b'
  ...
  JOIN public.source_papers ms ON ms.syllabus_id=sy.id AND ms.component_id=c.id
    ...
    AND ms.sha256='16b8a6e3a0db965cf92180095778335e3d71b38421608cf2345bd7ae729db365'
  ...
  IF v_qp IS NULL OR v_ms IS NULL THEN
    RAISE EXCEPTION '0186 exact 9618/41/M/J/26 QP/MS source gate failed';
  END IF;
  ...
  IF v_leaves<>23 OR v_edges<>23 THEN
    RAISE EXCEPTION '0186 precondition failed leaves=% edges=% expected=23/23',v_leaves,v_edges;
  END IF;
END $$;
...
WITH paper AS (
  ...
  VALUES
    ('9618/41/M/J/26 Q1(a)','19.1'),
    ('9618/41/M/J/26 Q1(b)','19.1'),
    ('9618/41/M/J/26 Q1(c)(i)','19.1'),
    ('9618/41/M/J/26 Q1(c)(ii)','19.1'),
    ('9618/41/M/J/26 Q1(d)','19.1'),
    ('9618/41/M/J/26 Q1(e)(i)','19.1'),
    ('9618/41/M/J/26 Q1(e)(ii)','19.1'),

    ('9618/41/M/J/26 Q2(a)','20.1'),
    ('9618/41/M/J/26 Q2(b)(i)','20.2'),
    ('9618/41/M/J/26 Q2(b)(ii)','20.1'),
    ('9618/41/M/J/26 Q2(b)(iii)','20.2'),
    ('9618/41/M/J/26 Q2(b)(iv)','20.2'),
    ('9618/41/M/J/26 Q2(c)(i)','20.1'),
    ('9618/41/M/J/26 Q2(c)(ii)','20.2'),
    ('9618/41/M/J/26 Q2(c)(iii)','20.2'),
    ('9618/41/M/J/26 Q2(c)(iv)','20.2'),

    ('9618/41/M/J/26 Q3(a)(i)','20.1'),
    ('9618/41/M/J/26 Q3(a)(ii)','20.1'),
    ('9618/41/M/J/26 Q3(a)(iii)','20.1'),
    ('9618/41/M/J/26 Q3(a)(iv)','20.1'),
    ('9618/41/M/J/26 Q3(a)(v)','20.1'),
    ('9618/41/M/J/26 Q3(b)(i)','20.1'),
    ('9618/41/M/J/26 Q3(b)(ii)','20.1')
), tl(display_ref,lo_code) AS (
  VALUES
    ('9618/41/M/J/26 Q1(a)','19.1.4'),
    ('9618/41/M/J/26 Q1(b)','19.1.3'),
    ('9618/41/M/J/26 Q1(c)(i)','19.1.3'),
    ('9618/41/M/J/26 Q1(c)(ii)','19.1.3'),
    ('9618/41/M/J/26 Q1(d)','19.1.3'),
    ('9618/41/M/J/26 Q1(e)(i)','19.1.3'),
    ('9618/41/M/J/26 Q1(e)(ii)','19.1.3'),

    ('9618/41/M/J/26 Q2(a)','20.1.1'),
    ('9618/41/M/J/26 Q2(b)(i)','20.2.1'),
    ('9618/41/M/J/26 Q2(b)(i)','20.2.4'),
    ('9618/41/M/J/26 Q2(b)(ii)','20.1.1'),
    ('9618/41/M/J/26 Q2(b)(iii)','20.2.1'),
    ('9618/41/M/J/26 Q2(b)(iv)','20.2.1'),
    ('9618/41/M/J/26 Q2(c)(i)','20.1.1'),
    ('9618/41/M/J/26 Q2(c)(ii)','20.2.1'),
    ('9618/41/M/J/26 Q2(c)(ii)','20.2.4'),
    ('9618/41/M/J/26 Q2(c)(iii)','20.2.1'),
    ('9618/41/M/J/26 Q2(c)(iv)','20.2.1'),

    ('9618/41/M/J/26 Q3(a)(i)','20.1.1'),
    ('9618/41/M/J/26 Q3(a)(ii)','20.1.1'),
    ('9618/41/M/J/26 Q3(a)(iii)','20.1.1'),
    ('9618/41/M/J/26 Q3(a)(iv)','20.1.1'),
    ('9618/41/M/J/26 Q3(a)(v)','20.1.1'),
    ('9618/41/M/J/26 Q3(b)(i)','20.1.1'),
    ('9618/41/M/J/26 Q3(b)(ii)','20.1.1')
), state AS (
...
SELECT
  question_id,source_paper_id,'manual-source-audit-0186-2026-mj41',
  ...
  jsonb_build_object(
    ...
    'qp_filename','9618_s26_qp_41.pdf','qp_sha256',qp_sha,'qp_source_url',qp_url,
    'ms_filename','9618_s26_ms_41.pdf','ms_sha256',ms_sha,'ms_source_url',ms_url,
    'syllabus_source_url','https://drive.google.com/file/d/1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw/view',
    'precedent','2025 source-reviewed Paper 4 queue/file/OOP mappings'
  )
FROM final_state s
WHERE NOT EXISTS (
  SELECT 1 FROM public.question_taxonomy_review_history h
  WHERE h.question_id=s.question_id
    AND h.review_tag='manual-source-audit-0186-2026-mj41'
);

-- Replace classifier LO output with 25 source-reviewed objective edges.
WITH p AS (
  SELECT qp.id
...
-- Rebuild reviewed primary subtopics.
WITH p AS (
  SELECT qp.id
  FROM public.source_papers qp
  JOIN public.syllabi sy ON sy.id=qp.syllabus_id
...
WITH tp(display_ref,new_primary) AS (
  VALUES
    ('9618/41/M/J/26 Q1(a)','19.1'),('9618/41/M/J/26 Q1(b)','19.1'),
    ('9618/41/M/J/26 Q1(c)(i)','19.1'),('9618/41/M/J/26 Q1(c)(ii)','19.1'),
    ('9618/41/M/J/26 Q1(d)','19.1'),('9618/41/M/J/26 Q1(e)(i)','19.1'),('9618/41/M/J/26 Q1(e)(ii)','19.1'),
    ('9618/41/M/J/26 Q2(a)','20.1'),('9618/41/M/J/26 Q2(b)(i)','20.2'),
    ('9618/41/M/J/26 Q2(b)(ii)','20.1'),('9618/41/M/J/26 Q2(b)(iii)','20.2'),
    ('9618/41/M/J/26 Q2(b)(iv)','20.2'),('9618/41/M/J/26 Q2(c)(i)','20.1'),
    ('9618/41/M/J/26 Q2(c)(ii)','20.2'),('9618/41/M/J/26 Q2(c)(iii)','20.2'),('9618/41/M/J/26 Q2(c)(iv)','20.2'),
    ('9618/41/M/J/26 Q3(a)(i)','20.1'),('9618/41/M/J/26 Q3(a)(ii)','20.1'),
    ('9618/41/M/J/26 Q3(a)(iii)','20.1'),('9618/41/M/J/26 Q3(a)(iv)','20.1'),
    ('9618/41/M/J/26 Q3(a)(v)','20.1'),('9618/41/M/J/26 Q3(b)(i)','20.1'),('9618/41/M/J/26 Q3(b)(ii)','20.1')
), p AS (
  SELECT qp.id,qp.syllabus_id
  FROM public.source_papers qp
  JOIN public.syllabi sy ON sy.id=qp.syllabus_id
...
SELECT question_id,subtopic_id,true,1.0,1.0,'manual-source-audit-0186'
FROM r
ON CONFLICT(question_id,subtopic_id)
DO UPDATE SET is_primary=true,weight=1.0,confidence=1.0,set_by='manual-source-audit-0186';

DO $$
DECLARE
  v_qp uuid; v_history int; v_edges int; v_primary int; v_low_p int; v_low_lo int;
  v_q1a int; v_q1b int; v_q2bi int; v_q2bii int; v_q2ci int; v_q2cii int;
BEGIN
  ...
  SELECT count(*) INTO v_q1a
  FROM public.questions q
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q1(a)' AND lo.code='19.1.4';

  SELECT count(*) INTO v_q1b
  FROM public.questions q
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q1(b)' AND lo.code='19.1.3';

  SELECT count(*) INTO v_q2bi
  FROM public.questions q
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q2(b)(i)'
    AND lo.code IN ('20.2.1','20.2.4');

  SELECT count(*) INTO v_q2bii
  FROM public.questions q
  JOIN public.question_subtopics qs ON qs.question_id=q.id AND qs.is_primary
  JOIN public.subtopics st ON st.id=qs.subtopic_id
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q2(b)(ii)'
    AND st.code='20.1' AND lo.code='20.1.1';

  SELECT count(*) INTO v_q2ci
  FROM public.questions q
  JOIN public.question_subtopics qs ON qs.question_id=q.id AND qs.is_primary
  JOIN public.subtopics st ON st.id=qs.subtopic_id
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q2(c)(i)'
    AND st.code='20.1' AND lo.code='20.1.1';

  SELECT count(*) INTO v_q2cii
  FROM public.questions q
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/41/M/J/26 Q2(c)(ii)'
    AND lo.code IN ('20.2.1','20.2.4');

  IF v_history<>23 OR v_edges<>25 OR v_primary<>23 OR v_low_p<>0 OR v_low_lo<>0
     OR v_q1a<>1 OR v_q1b<>1 OR v_q2bi<>2 OR v_q2bii<>1 OR v_q2ci<>1 OR v_q2cii<>2 THEN
    RAISE EXCEPTION
      '0186 closure failed history=% edges=% primary=% low_primary=% low_lo=% q1a=% q1b=% q2bi=% q2bii=% q2ci=% q2cii=%',
      v_history,v_edges,v_primary,v_low_p,v_low_lo,v_q1a,v_q1b,v_q2bi,v_q2bii,v_q2ci,v_q2cii;
  END IF;
END $$;
