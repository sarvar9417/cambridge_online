-- Source-backed atomic normalization for explicit 2025 O/N C2/C3 rubrics.
-- Official Cambridge 9618/21 and 9618/31 O/N 2025 mark schemes are authoritative.
-- Safety: natural keys only, unused single wrappers only, no existing groups, idempotent.

with target(component,path,expected_marks,scheme_kind) as (
  values
    (2,'4.a',6,'all_required'),(2,'6.b',7,'all_required'),(2,'8.a',7,'all_required'),(2,'8.b',8,'all_required'),
  ...
  values
    (3,'9.a.i','completed_lines',5,5,1),
    (3,'10','explanation',2,2,1),(3,'10','example',1,1,2)
  ...
  values
    ...
    (3,'1.a.ii','MP1','Assign 984632 to Member1.Code.','', '[]'::jsonb,1),
    (3,'1.a.ii','MP2','Assign TRUE to Member1.FeesPaid.','', '[]'::jsonb,2),
    (3,'1.b.i','MP1','Declare the enumerated type with TYPE Activity =.','', '[]'::jsonb,1),
    (3,'1.b.i','MP2','Include Badminton, Football, Golf, Snooker, Swimming and Tennis as the enumeration values.','', '[]'::jsonb,2),

    (3,'9.a.i','P1','Complete the function heading with RETURNS STRING.','completed_lines','[]'::jsonb,1),
    (3,'9.a.i','P2','Assign the empty string to DataItem.','completed_lines','[]'::jsonb,2),
    (3,'9.a.i','P3','Use a valid non-empty-stack condition: Top > -1 or Top >= Base.','completed_lines','[]'::jsonb,3),
    (3,'9.a.i','P4','Assign StackArray[Top] to DataItem.','completed_lines','[]'::jsonb,4),
    (3,'9.a.i','P5','Decrement Top by 1.','completed_lines','[]'::jsonb,5),
    (3,'9.a.i','P6','Return DataItem, or equivalently StackArray[Top + 1].','completed_lines','[]'::jsonb,6),

    (3,'10','E1','Exception handling responds to unwanted or unexpected events when a program runs.','explanation','[]'::jsonb,1),
    (3,'10','E2','Exception handling prevents the program or computer from stopping unexpectedly.','explanation','[]'::jsonb,2),
    (3,'10','X1','Example cause: programming error.','example','[]'::jsonb,3),
    (3,'10','X2','Example cause: user error.','example','[]'::jsonb,4),
    (3,'10','X3','Example cause: hardware failure or loss of connection to a device.','example','[]'::jsonb,5),

    (3,'11.a','MP1','LDM #100 is present.','', '[]'::jsonb,1),
    (3,'11.a','MP2','Correctly use STO with a labelled address for the constant or answer.','', '[]'::jsonb,2),
    (3,'11.a','MP3','Correctly use LDD 632.','', '[]'::jsonb,3),
    (3,'11.a','MP4','Correctly use SUB with the labelled constant address.','', '[]'::jsonb,4),
    (3,'11.a','MP5','Store 100 at a labelled address away from the code.','', '[]'::jsonb,5),
    (3,'11.a','MP6','Label both data addresses away from the code.','', '[]'::jsonb,6)
), validated as (
...
with target(component,path,expected_marks,scheme_kind,expected_points,expected_groups) as (
  values
    (2,'4.a',6,'all_required',6,0),(2,'6.b',7,'all_required',7,0),(2,'8.a',7,'all_required',7,0),(2,'8.b',8,'all_required',8,0),
    (3,'1.a.ii',2,'all_required',2,0),(3,'1.b.i',2,'all_required',2,0),(3,'9.a.i',5,'any_n_from_m',6,1),
    (3,'10',3,'any_n_from_m',5,2),(3,'11.a',6,'all_required',6,0)
), resolved as (
...
update mark_schemes ms set scheme_type=v.scheme_kind::scheme_type,prompt_version='atomic-source-2025-on-explicit-code-v1',updated_at=now()
