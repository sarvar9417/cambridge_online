...
-- identity was materialized in 0144-0152.
--
...
SELECT target_lo.id,source_lo.id,'equivalent',
       'predeploy-0153: Historical 1.1-lo-00 is text-identical to current 1.1.1 (binary magnitudes and binary-versus-decimal prefixes).'
