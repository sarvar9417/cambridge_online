-- 0180_9618_2026_mj21_taxonomy_closure.sql
-- Source-backed taxonomy closure for Cambridge 9618/21/M/J/26.
-- QP SHA256: 87fad77773dad215ca292585f721064bf754451299505e5cedba0953f27f5fe0
-- MS SHA256: 3f52bd3676a68f5f23a82704ef058528ca9c8387a4468cf80a15be19c5872795
-- Syllabus source: Cambridge 9618 syllabus for 2026, Drive 1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw
--
-- All 28 approved scoring leaves are manually adjudicated against the QP,
-- MS and official syllabus. Existing question/MS/LaTeX/source content is not changed.
...
BEGIN
  ...
  JOIN public.source_papers qp ON qp.syllabus_id=sy.id AND qp.component_id=c.id
    ...
    AND qp.sha256='87fad77773dad215ca292585f721064bf754451299505e5cedba0953f27f5fe0'
  ...
  JOIN public.source_papers ms ON ms.syllabus_id=sy.id AND ms.component_id=c.id
    ...
    AND ms.sha256='3f52bd3676a68f5f23a82704ef058528ca9c8387a4468cf80a15be19c5872795'
    AND ms.page_count=14 AND nullif(btrim(coalesce(ms.source_url,'')),'') IS NOT NULL
  WHERE sy.code='9618' AND sy.version_label='2026-2028';

  IF v_qp IS NULL OR v_ms IS NULL THEN
    RAISE EXCEPTION '0180 exact 9618/21/M/J/26 QP/MS source gate failed';
  END IF;
  ...
  IF v_leaves<>28 OR v_edges<>28 THEN
    RAISE EXCEPTION '0180 precondition failed leaves=% edges=% expected=28/28',v_leaves,v_edges;
  END IF;
END $$;
...
WITH paper AS (
  ...
  VALUES
    ('9618/21/M/J/26 Q1(a)','11.2'),
    ('9618/21/M/J/26 Q1(b)','11.2'),
    ('9618/21/M/J/26 Q2(a)(i)','10.1'),
    ('9618/21/M/J/26 Q2(a)(ii)','11.1'),
    ('9618/21/M/J/26 Q2(a)(iii)','11.1'),
    ('9618/21/M/J/26 Q2(b)(i)','12.3'),
    ('9618/21/M/J/26 Q2(b)(ii)','12.3'),
    ('9618/21/M/J/26 Q3(a)','12.1'),
    ('9618/21/M/J/26 Q3(b)','12.3'),
    ('9618/21/M/J/26 Q4','9.2'),
    ('9618/21/M/J/26 Q5(a)','11.3'),
    ('9618/21/M/J/26 Q5(b)','11.3'),
    ('9618/21/M/J/26 Q6(a)','11.1'),
    ('9618/21/M/J/26 Q6(b)','11.3'),
    ('9618/21/M/J/26 Q6(c)','10.3'),
    ('9618/21/M/J/26 Q7(a)(i)','10.4'),
    ('9618/21/M/J/26 Q7(a)(ii)','10.4'),
    ('9618/21/M/J/26 Q7(b)(i)','10.4'),
    ('9618/21/M/J/26 Q7(b)(ii)','10.4'),
    ('9618/21/M/J/26 Q7(b)(iii)','10.4'),
    ('9618/21/M/J/26 Q7(c)','10.4'),
    ('9618/21/M/J/26 Q8(a)','12.3'),
    ('9618/21/M/J/26 Q8(b)','12.3'),
    ('9618/21/M/J/26 Q8(c)','12.3'),
    ('9618/21/M/J/26 Q9(a)','10.2'),
    ('9618/21/M/J/26 Q9(b)','10.2'),
    ('9618/21/M/J/26 Q9(c)(i)','10.1'),
    ('9618/21/M/J/26 Q9(c)(ii)','10.2')
), tl(display_ref,lo_code) AS (
  VALUES
    ('9618/21/M/J/26 Q1(a)','11.2.1'),
    ('9618/21/M/J/26 Q1(b)','11.2.1'),
    ('9618/21/M/J/26 Q2(a)(i)','10.1.1'),
    ('9618/21/M/J/26 Q2(a)(ii)','11.1.2'),
    ('9618/21/M/J/26 Q2(a)(iii)','11.1.2'),
    ('9618/21/M/J/26 Q2(a)(iii)','11.2.1'),
    ('9618/21/M/J/26 Q2(b)(i)','12.3.1'),
    ('9618/21/M/J/26 Q2(b)(ii)','12.3.1'),
    ('9618/21/M/J/26 Q3(a)','12.1.4'),
    ('9618/21/M/J/26 Q3(b)','12.1.4'),
    ('9618/21/M/J/26 Q3(b)','9.1.3'),
    ('9618/21/M/J/26 Q3(b)','12.3.2'),
    ('9618/21/M/J/26 Q3(b)','12.3.5'),
    ('9618/21/M/J/26 Q4','9.2.5'),
    ('9618/21/M/J/26 Q5(a)','11.3.2'),
    ('9618/21/M/J/26 Q5(a)','11.3.6'),
    ('9618/21/M/J/26 Q5(b)','11.3.2'),
    ('9618/21/M/J/26 Q5(b)','11.3.6'),
    ('9618/21/M/J/26 Q6(a)','11.1.3'),
    ('9618/21/M/J/26 Q6(b)','11.3.2'),
    ('9618/21/M/J/26 Q6(b)','11.3.6'),
    ('9618/21/M/J/26 Q6(b)','11.1.3'),
    ('9618/21/M/J/26 Q6(c)','10.3.2'),
    ('9618/21/M/J/26 Q7(a)(i)','10.4.3'),
    ('9618/21/M/J/26 Q7(a)(ii)','10.4.3'),
    ('9618/21/M/J/26 Q7(b)(i)','10.4.5'),
    ('9618/21/M/J/26 Q7(b)(ii)','10.4.4'),
    ('9618/21/M/J/26 Q7(b)(iii)','10.4.4'),
    ('9618/21/M/J/26 Q7(c)','10.4.5'),
    ('9618/21/M/J/26 Q7(c)','11.3.1'),
    ('9618/21/M/J/26 Q7(c)','11.2.1'),
    ('9618/21/M/J/26 Q8(a)','12.3.2'),
    ('9618/21/M/J/26 Q8(b)','12.3.2'),
    ('9618/21/M/J/26 Q8(c)','12.3.2'),
    ('9618/21/M/J/26 Q9(a)','10.2.3'),
    ('9618/21/M/J/26 Q9(b)','10.2.4'),
    ('9618/21/M/J/26 Q9(c)(i)','10.1.3'),
    ('9618/21/M/J/26 Q9(c)(ii)','10.1.4'),
    ('9618/21/M/J/26 Q9(c)(ii)','10.2.4'),
    ('9618/21/M/J/26 Q9(c)(ii)','11.2.1')
), state AS (
  ...
  JOIN public.questions q
    ON q.display_ref=tp.display_ref
  ...
  SELECT s.*,
    ...
    (SELECT jsonb_agg(jsonb_build_object(
        'lo_id',lo.id,'code',lo.code,'confidence',1.0
      ) ORDER BY lo.code)
     FROM tl
...
SELECT
  question_id,source_paper_id,'manual-source-audit-0180-2026-mj21',
  ...
  jsonb_build_object(
    ...
    'qp_filename','9618_s26_qp_21.pdf','qp_sha256',qp_sha,'qp_source_url',qp_url,
    'ms_filename','9618_s26_ms_21.pdf','ms_sha256',ms_sha,'ms_source_url',ms_url,
...
WHERE NOT EXISTS (
  ...
  WHERE h.question_id=s.question_id AND h.review_tag='manual-source-audit-0180-2026-mj21'
);

-- Replace the classifier's one-edge-per-leaf LO output with the 40 reviewed edges.
WITH p AS (
  SELECT qp.id
...
WITH tl(display_ref,lo_code) AS (
  VALUES
    ('9618/21/M/J/26 Q1(a)','11.2.1'),('9618/21/M/J/26 Q1(b)','11.2.1'),
    ('9618/21/M/J/26 Q2(a)(i)','10.1.1'),('9618/21/M/J/26 Q2(a)(ii)','11.1.2'),
    ('9618/21/M/J/26 Q2(a)(iii)','11.1.2'),('9618/21/M/J/26 Q2(a)(iii)','11.2.1'),
    ('9618/21/M/J/26 Q2(b)(i)','12.3.1'),('9618/21/M/J/26 Q2(b)(ii)','12.3.1'),
    ('9618/21/M/J/26 Q3(a)','12.1.4'),('9618/21/M/J/26 Q3(b)','12.1.4'),
    ('9618/21/M/J/26 Q3(b)','9.1.3'),('9618/21/M/J/26 Q3(b)','12.3.2'),
    ('9618/21/M/J/26 Q3(b)','12.3.5'),('9618/21/M/J/26 Q4','9.2.5'),
    ('9618/21/M/J/26 Q5(a)','11.3.2'),('9618/21/M/J/26 Q5(a)','11.3.6'),
    ('9618/21/M/J/26 Q5(b)','11.3.2'),('9618/21/M/J/26 Q5(b)','11.3.6'),
    ('9618/21/M/J/26 Q6(a)','11.1.3'),('9618/21/M/J/26 Q6(b)','11.3.2'),
    ('9618/21/M/J/26 Q6(b)','11.3.6'),('9618/21/M/J/26 Q6(b)','11.1.3'),
    ('9618/21/M/J/26 Q6(c)','10.3.2'),('9618/21/M/J/26 Q7(a)(i)','10.4.3'),
    ('9618/21/M/J/26 Q7(a)(ii)','10.4.3'),('9618/21/M/J/26 Q7(b)(i)','10.4.5'),
    ('9618/21/M/J/26 Q7(b)(ii)','10.4.4'),('9618/21/M/J/26 Q7(b)(iii)','10.4.4'),
    ('9618/21/M/J/26 Q7(c)','10.4.5'),('9618/21/M/J/26 Q7(c)','11.3.1'),
    ('9618/21/M/J/26 Q7(c)','11.2.1'),('9618/21/M/J/26 Q8(a)','12.3.2'),
    ('9618/21/M/J/26 Q8(b)','12.3.2'),('9618/21/M/J/26 Q8(c)','12.3.2'),
    ('9618/21/M/J/26 Q9(a)','10.2.3'),('9618/21/M/J/26 Q9(b)','10.2.4'),
    ('9618/21/M/J/26 Q9(c)(i)','10.1.3'),('9618/21/M/J/26 Q9(c)(ii)','10.1.4'),
    ('9618/21/M/J/26 Q9(c)(ii)','10.2.4'),('9618/21/M/J/26 Q9(c)(ii)','11.2.1')
), p AS (
...
-- Rebuild all 28 primary subtopic links to the reviewed target.
WITH tp(display_ref,new_primary) AS (
  VALUES
    ('9618/21/M/J/26 Q1(a)','11.2'),('9618/21/M/J/26 Q1(b)','11.2'),
    ('9618/21/M/J/26 Q2(a)(i)','10.1'),('9618/21/M/J/26 Q2(a)(ii)','11.1'),
    ('9618/21/M/J/26 Q2(a)(iii)','11.1'),('9618/21/M/J/26 Q2(b)(i)','12.3'),
    ('9618/21/M/J/26 Q2(b)(ii)','12.3'),('9618/21/M/J/26 Q3(a)','12.1'),
    ('9618/21/M/J/26 Q3(b)','12.3'),('9618/21/M/J/26 Q4','9.2'),
    ('9618/21/M/J/26 Q5(a)','11.3'),('9618/21/M/J/26 Q5(b)','11.3'),
    ('9618/21/M/J/26 Q6(a)','11.1'),('9618/21/M/J/26 Q6(b)','11.3'),
    ('9618/21/M/J/26 Q6(c)','10.3'),('9618/21/M/J/26 Q7(a)(i)','10.4'),
    ('9618/21/M/J/26 Q7(a)(ii)','10.4'),('9618/21/M/J/26 Q7(b)(i)','10.4'),
    ('9618/21/M/J/26 Q7(b)(ii)','10.4'),('9618/21/M/J/26 Q7(b)(iii)','10.4'),
    ('9618/21/M/J/26 Q7(c)','10.4'),('9618/21/M/J/26 Q8(a)','12.3'),
    ('9618/21/M/J/26 Q8(b)','12.3'),('9618/21/M/J/26 Q8(c)','12.3'),
    ('9618/21/M/J/26 Q9(a)','10.2'),('9618/21/M/J/26 Q9(b)','10.2'),
    ('9618/21/M/J/26 Q9(c)(i)','10.1'),('9618/21/M/J/26 Q9(c)(ii)','10.2')
), p AS (
  SELECT qp.id,qp.syllabus_id
  FROM public.source_papers qp
  JOIN public.syllabi sy ON sy.id=qp.syllabus_id
...
SELECT question_id,subtopic_id,true,1.0,1.0,'manual-source-audit-0180'
FROM r
ON CONFLICT(question_id,subtopic_id)
DO UPDATE SET is_primary=true,weight=1.0,confidence=1.0,set_by='manual-source-audit-0180';
...
BEGIN
  ...
  WHERE q.source_paper_id=v_qp AND h.review_tag='manual-source-audit-0180-2026-mj21';
  ...
  IF v_history<>28 OR v_edges<>40 OR v_primary<>28 OR v_low_p<>0 OR v_low_lo<>0 THEN
    RAISE EXCEPTION
      '0180 closure failed history=% edges=% primary=% low_primary=% low_lo=%',
