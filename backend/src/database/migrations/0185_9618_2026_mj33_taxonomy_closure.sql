-- 0185_9618_2026_mj33_taxonomy_closure.sql
-- Source-backed taxonomy closure for Cambridge 9618/33/M/J/26.
-- QP SHA256: f23488a0b03097d8f4ea71e2bd527f412100bd339077600a35c19f67bd1f5014
-- MS SHA256: fbd4b71ff8210b4f2a1c8b7e34974e9ef19d5fe6b28e14d1838a73a83aa874a7
-- Official syllabus: Cambridge 9618 syllabus for 2026, Drive 1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw
--
-- All 26 approved scoring leaves are manually adjudicated. This corrects,
-- among others, quantum cryptography to 17.1, regression to 18.1.5, RPN to
-- 16.2.4, binary-search tasks to 19.1.1, and low-level assembly to 20.1.
-- No question/MS/LaTeX/source content is rewritten.
...
BEGIN
  ...
  JOIN public.source_papers qp ON qp.syllabus_id=sy.id AND qp.component_id=c.id
    ...
    AND qp.sha256='f23488a0b03097d8f4ea71e2bd527f412100bd339077600a35c19f67bd1f5014'
  ...
  JOIN public.source_papers ms ON ms.syllabus_id=sy.id AND ms.component_id=c.id
    ...
    AND ms.sha256='fbd4b71ff8210b4f2a1c8b7e34974e9ef19d5fe6b28e14d1838a73a83aa874a7'
    AND ms.page_count=18 AND nullif(btrim(coalesce(ms.source_url,'')),'') IS NOT NULL
  WHERE sy.code='9618' AND sy.version_label='2026-2028';

  IF v_qp IS NULL OR v_ms IS NULL THEN RAISE EXCEPTION '0185 exact 9618/33/M/J/26 source gate failed'; END IF;
  ...
  IF v_leaves<>26 OR v_edges<>26 THEN
    RAISE EXCEPTION '0185 precondition failed leaves=% edges=% expected=26/26',v_leaves,v_edges;
  END IF;
END $$;
...
WITH paper AS (
  ...
  VALUES
    ('9618/33/M/J/26 Q1(a)','13.1'),('9618/33/M/J/26 Q1(b)','13.1'),('9618/33/M/J/26 Q2','14.1'),
    ('9618/33/M/J/26 Q3(a)','13.2'),('9618/33/M/J/26 Q3(b)','13.2'),('9618/33/M/J/26 Q3(c)','13.2'),
    ('9618/33/M/J/26 Q4(a)','15.1'),('9618/33/M/J/26 Q4(b)','15.1'),
    ('9618/33/M/J/26 Q5(a)','13.3'),('9618/33/M/J/26 Q5(b)','13.3'),
    ('9618/33/M/J/26 Q6(a)(i)','15.2'),('9618/33/M/J/26 Q6(a)(ii)','15.2'),
    ('9618/33/M/J/26 Q6(a)(iii)','15.2'),('9618/33/M/J/26 Q6(b)','15.2'),
    ('9618/33/M/J/26 Q7(a)','16.2'),('9618/33/M/J/26 Q7(b)','16.2'),('9618/33/M/J/26 Q7(c)','16.2'),
    ('9618/33/M/J/26 Q8(a)','17.1'),('9618/33/M/J/26 Q8(b)','17.1'),
    ('9618/33/M/J/26 Q9(a)','18.1'),('9618/33/M/J/26 Q9(b)','18.1'),
    ('9618/33/M/J/26 Q10(a)(i)','19.1'),('9618/33/M/J/26 Q10(a)(ii)','19.1'),('9618/33/M/J/26 Q10(b)','19.1'),
    ('9618/33/M/J/26 Q11(a)','20.1'),('9618/33/M/J/26 Q11(b)','20.1')
), tl(display_ref,lo_code) AS (
  VALUES
    ('9618/33/M/J/26 Q1(a)','13.1.1'),('9618/33/M/J/26 Q1(b)','13.1.2'),
    ('9618/33/M/J/26 Q2','14.1.2'),
    ('9618/33/M/J/26 Q3(a)','13.2.1'),('9618/33/M/J/26 Q3(b)','13.2.1'),('9618/33/M/J/26 Q3(c)','13.2.2'),
    ('9618/33/M/J/26 Q4(a)','15.1.4'),('9618/33/M/J/26 Q4(b)','15.1.3'),
    ('9618/33/M/J/26 Q5(a)','13.3.2'),('9618/33/M/J/26 Q5(a)','13.3.3'),
    ('9618/33/M/J/26 Q5(b)','13.3.4'),
    ('9618/33/M/J/26 Q6(a)(i)','15.2.8'),('9618/33/M/J/26 Q6(a)(ii)','15.2.8'),
    ('9618/33/M/J/26 Q6(a)(iii)','15.2.6'),
    ('9618/33/M/J/26 Q6(b)','15.2.5'),('9618/33/M/J/26 Q6(b)','15.2.6'),
    ('9618/33/M/J/26 Q7(a)','16.2.4'),('9618/33/M/J/26 Q7(b)','16.2.4'),('9618/33/M/J/26 Q7(c)','16.2.4'),
    ('9618/33/M/J/26 Q8(a)','17.1.1'),('9618/33/M/J/26 Q8(b)','17.1.1'),
    ('9618/33/M/J/26 Q9(a)','18.1.5'),('9618/33/M/J/26 Q9(b)','18.1.1'),
    ('9618/33/M/J/26 Q10(a)(i)','19.1.1'),('9618/33/M/J/26 Q10(a)(ii)','19.1.1'),
    ('9618/33/M/J/26 Q10(b)','19.1.1'),('9618/33/M/J/26 Q10(b)','19.1.5'),
    ('9618/33/M/J/26 Q11(a)','20.1.1'),('9618/33/M/J/26 Q11(b)','20.1.1')
), state AS (
...
SELECT question_id,source_paper_id,'manual-source-audit-0185-2026-mj33',
  ...
  jsonb_build_object(
    ...
    'qp_filename','9618_s26_qp_33.pdf','qp_sha256',qp_sha,'qp_source_url',qp_url,
    'ms_filename','9618_s26_ms_33.pdf','ms_sha256',ms_sha,'ms_source_url',ms_url,
...
WHERE NOT EXISTS (
  ...
  WHERE h.question_id=s.question_id AND h.review_tag='manual-source-audit-0185-2026-mj33'
);
...
WITH tl(display_ref,lo_code) AS (
  VALUES
    ('9618/33/M/J/26 Q1(a)','13.1.1'),('9618/33/M/J/26 Q1(b)','13.1.2'),('9618/33/M/J/26 Q2','14.1.2'),
    ('9618/33/M/J/26 Q3(a)','13.2.1'),('9618/33/M/J/26 Q3(b)','13.2.1'),('9618/33/M/J/26 Q3(c)','13.2.2'),
    ('9618/33/M/J/26 Q4(a)','15.1.4'),('9618/33/M/J/26 Q4(b)','15.1.3'),
    ('9618/33/M/J/26 Q5(a)','13.3.2'),('9618/33/M/J/26 Q5(a)','13.3.3'),('9618/33/M/J/26 Q5(b)','13.3.4'),
    ('9618/33/M/J/26 Q6(a)(i)','15.2.8'),('9618/33/M/J/26 Q6(a)(ii)','15.2.8'),
    ('9618/33/M/J/26 Q6(a)(iii)','15.2.6'),('9618/33/M/J/26 Q6(b)','15.2.5'),('9618/33/M/J/26 Q6(b)','15.2.6'),
    ('9618/33/M/J/26 Q7(a)','16.2.4'),('9618/33/M/J/26 Q7(b)','16.2.4'),('9618/33/M/J/26 Q7(c)','16.2.4'),
    ('9618/33/M/J/26 Q8(a)','17.1.1'),('9618/33/M/J/26 Q8(b)','17.1.1'),
    ('9618/33/M/J/26 Q9(a)','18.1.5'),('9618/33/M/J/26 Q9(b)','18.1.1'),
    ('9618/33/M/J/26 Q10(a)(i)','19.1.1'),('9618/33/M/J/26 Q10(a)(ii)','19.1.1'),
...
WITH tp(display_ref,new_primary) AS (
  VALUES
    ...
    ('9618/33/M/J/26 Q4(a)','15.1'),('9618/33/M/J/26 Q4(b)','15.1'),
    ('9618/33/M/J/26 Q5(a)','13.3'),('9618/33/M/J/26 Q5(b)','13.3'),
    ('9618/33/M/J/26 Q6(a)(i)','15.2'),('9618/33/M/J/26 Q6(a)(ii)','15.2'),('9618/33/M/J/26 Q6(a)(iii)','15.2'),('9618/33/M/J/26 Q6(b)','15.2'),
    ('9618/33/M/J/26 Q7(a)','16.2'),('9618/33/M/J/26 Q7(b)','16.2'),('9618/33/M/J/26 Q7(c)','16.2'),
    ('9618/33/M/J/26 Q8(a)','17.1'),('9618/33/M/J/26 Q8(b)','17.1'),
    ('9618/33/M/J/26 Q9(a)','18.1'),('9618/33/M/J/26 Q9(b)','18.1'),
    ('9618/33/M/J/26 Q10(a)(i)','19.1'),('9618/33/M/J/26 Q10(a)(ii)','19.1'),('9618/33/M/J/26 Q10(b)','19.1'),
...
SELECT question_id,subtopic_id,true,1.0,1.0,'manual-source-audit-0185' FROM r
ON CONFLICT(question_id,subtopic_id)
DO UPDATE SET is_primary=true,weight=1.0,confidence=1.0,set_by='manual-source-audit-0185';

DO $$
DECLARE v_qp uuid; v_history int; v_edges int; v_primary int; v_low_p int; v_low_lo int; v_quantum int;
BEGIN
  ...
  WHERE q.source_paper_id=v_qp AND h.review_tag='manual-source-audit-0185-2026-mj33';
  ...
  SELECT count(*) INTO v_quantum FROM public.questions q
  JOIN public.question_subtopics qs ON qs.question_id=q.id AND qs.is_primary
  ...
  WHERE q.source_paper_id=v_qp
    AND q.display_ref IN ('9618/33/M/J/26 Q8(a)','9618/33/M/J/26 Q8(b)')
    AND st.code='17.1' AND lo.code='17.1.1';

  IF v_history<>26 OR v_edges<>29 OR v_primary<>26 OR v_low_p<>0 OR v_low_lo<>0 OR v_quantum<>2 THEN
    RAISE EXCEPTION '0185 closure failed history=% edges=% primary=% low_primary=% low_lo=% quantum=%',
      v_history,v_edges,v_primary,v_low_p,v_low_lo,v_quantum;
  END IF;
END $$;
