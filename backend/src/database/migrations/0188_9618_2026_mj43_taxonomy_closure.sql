-- 0188_9618_2026_mj43_taxonomy_closure.sql
-- Source-backed taxonomy closure for Cambridge 9618/43/M/J/26.
-- QP SHA256: b85f57405cfce6bf8d70da1fe446437656f3f81b573e95c911a9e04f257d09eb
-- MS SHA256: 6892b35db63ca96ce19ebfd39922c4f8244fc7e924e0d5d84272eba422299dec
-- Official syllabus: Cambridge 9618 syllabus for 2026, Drive 1PvTiGuvynVCkW283YHHIRA5UZGjRrDRw
--
-- All 25 approved scoring leaves are manually adjudicated against the QP,
-- published MS, official syllabus, and source-reviewed Paper 4 precedents.
...
BEGIN
  ...
  JOIN public.source_papers qp ON qp.syllabus_id=sy.id AND qp.component_id=c.id
    ...
    AND qp.sha256='b85f57405cfce6bf8d70da1fe446437656f3f81b573e95c911a9e04f257d09eb'
  ...
  JOIN public.source_papers ms ON ms.syllabus_id=sy.id AND ms.component_id=c.id
    ...
    AND ms.sha256='6892b35db63ca96ce19ebfd39922c4f8244fc7e924e0d5d84272eba422299dec'
    AND ms.page_count=46 AND nullif(btrim(coalesce(ms.source_url,'')),'') IS NOT NULL
  WHERE sy.code='9618' AND sy.version_label='2026-2028';

  IF v_qp IS NULL OR v_ms IS NULL THEN
    RAISE EXCEPTION '0188 exact 9618/43/M/J/26 QP/MS source gate failed';
  END IF;
  ...
  IF v_leaves<>25 OR v_edges<>25 THEN
    RAISE EXCEPTION '0188 precondition failed leaves=% edges=% expected=25/25',v_leaves,v_edges;
  END IF;
END $$;
...
WITH paper AS (
  ...
  VALUES
    ('9618/43/M/J/26 Q1(a)','20.1'),
    ('9618/43/M/J/26 Q1(b)','20.1'),
    ('9618/43/M/J/26 Q1(c)','20.1'),
    ('9618/43/M/J/26 Q1(d)(i)','20.1'),
    ('9618/43/M/J/26 Q1(d)(ii)','20.1'),
    ('9618/43/M/J/26 Q1(e)','20.1'),
    ('9618/43/M/J/26 Q1(f)(i)','19.1'),
    ('9618/43/M/J/26 Q1(f)(ii)','19.1'),
    ('9618/43/M/J/26 Q1(f)(iii)','19.1'),

    ('9618/43/M/J/26 Q2(a)(i)','20.1'),
    ('9618/43/M/J/26 Q2(a)(ii)','20.1'),
    ('9618/43/M/J/26 Q2(b)','20.2'),
    ('9618/43/M/J/26 Q2(c)','20.1'),
    ('9618/43/M/J/26 Q2(d)(i)','20.2'),
    ('9618/43/M/J/26 Q2(d)(ii)','20.2'),
    ('9618/43/M/J/26 Q2(e)(i)','20.1'),
    ('9618/43/M/J/26 Q2(e)(ii)','20.1'),

    ('9618/43/M/J/26 Q3(a)','19.1'),
    ('9618/43/M/J/26 Q3(b)','19.1'),
    ('9618/43/M/J/26 Q3(c)','19.1'),
    ('9618/43/M/J/26 Q3(d)(i)','19.1'),
    ('9618/43/M/J/26 Q3(d)(ii)','19.1'),
    ('9618/43/M/J/26 Q3(e)(i)','19.2'),
    ('9618/43/M/J/26 Q3(e)(ii)','19.2'),
    ('9618/43/M/J/26 Q3(e)(iii)','19.2')
), tl(display_ref,lo_code) AS (
  VALUES
    ('9618/43/M/J/26 Q1(a)','20.1.1'),
    ('9618/43/M/J/26 Q1(b)','20.1.1'),
    ('9618/43/M/J/26 Q1(c)','20.1.1'),
    ('9618/43/M/J/26 Q1(d)(i)','20.1.1'),
    ('9618/43/M/J/26 Q1(d)(ii)','20.1.1'),
    ('9618/43/M/J/26 Q1(e)','20.1.1'),
    ('9618/43/M/J/26 Q1(f)(i)','19.1.2'),
    ('9618/43/M/J/26 Q1(f)(ii)','19.1.2'),
    ('9618/43/M/J/26 Q1(f)(iii)','19.1.2'),

    ('9618/43/M/J/26 Q2(a)(i)','20.1.1'),
    ('9618/43/M/J/26 Q2(a)(ii)','20.1.1'),
    ('9618/43/M/J/26 Q2(b)','20.2.1'),
    ('9618/43/M/J/26 Q2(b)','20.2.4'),
    ('9618/43/M/J/26 Q2(c)','20.1.1'),
    ('9618/43/M/J/26 Q2(d)(i)','20.2.1'),
    ('9618/43/M/J/26 Q2(d)(ii)','20.2.1'),
    ('9618/43/M/J/26 Q2(e)(i)','20.1.1'),
    ('9618/43/M/J/26 Q2(e)(ii)','20.1.1'),

    ('9618/43/M/J/26 Q3(a)','19.1.4'),
    ('9618/43/M/J/26 Q3(b)','19.1.3'),
    ('9618/43/M/J/26 Q3(c)','19.1.4'),
    ('9618/43/M/J/26 Q3(d)(i)','19.1.3'),
    ('9618/43/M/J/26 Q3(d)(ii)','19.1.3'),
    ('9618/43/M/J/26 Q3(e)(i)','19.2.1'),
    ('9618/43/M/J/26 Q3(e)(ii)','19.2.1'),
    ('9618/43/M/J/26 Q3(e)(iii)','19.2.1')
), state AS (
...
SELECT
  question_id,source_paper_id,'manual-source-audit-0188-2026-mj43',
  ...
  jsonb_build_object(
    'method','manual QP/MS + official 2026 syllabus + reviewed Paper 4 precedent',
    'question_status_preserved',true
  ),
  jsonb_build_object(
    'source_backed',true,'qualification','9618','syllabus_version','2026-2028',
    'qp_filename','9618_s26_qp_43.pdf','qp_sha256',qp_sha,'qp_source_url',qp_url,
    'ms_filename','9618_s26_ms_43.pdf','ms_sha256',ms_sha,'ms_source_url',ms_url,
...
WHERE NOT EXISTS (
  ...
  WHERE h.question_id=s.question_id
    AND h.review_tag='manual-source-audit-0188-2026-mj43'
);
...
WITH p AS (
  ...
  WHERE sy.code='9618' AND sy.version_label='2026-2028'
    ...
    AND qp.year=2026 AND qp.series='MJ'::exam_series AND qp.variant=3
    AND qp.sha256='b85f57405cfce6bf8d70da1fe446437656f3f81b573e95c911a9e04f257d09eb'
)
...
WITH tp(display_ref,new_primary) AS (
  VALUES
    ('9618/43/M/J/26 Q1(a)','20.1'),('9618/43/M/J/26 Q1(b)','20.1'),
    ('9618/43/M/J/26 Q1(c)','20.1'),('9618/43/M/J/26 Q1(d)(i)','20.1'),
    ('9618/43/M/J/26 Q1(d)(ii)','20.1'),('9618/43/M/J/26 Q1(e)','20.1'),
    ('9618/43/M/J/26 Q1(f)(i)','19.1'),('9618/43/M/J/26 Q1(f)(ii)','19.1'),('9618/43/M/J/26 Q1(f)(iii)','19.1'),
    ('9618/43/M/J/26 Q2(a)(i)','20.1'),('9618/43/M/J/26 Q2(a)(ii)','20.1'),
    ('9618/43/M/J/26 Q2(b)','20.2'),('9618/43/M/J/26 Q2(c)','20.1'),
    ('9618/43/M/J/26 Q2(d)(i)','20.2'),('9618/43/M/J/26 Q2(d)(ii)','20.2'),
    ('9618/43/M/J/26 Q2(e)(i)','20.1'),('9618/43/M/J/26 Q2(e)(ii)','20.1'),
    ('9618/43/M/J/26 Q3(a)','19.1'),('9618/43/M/J/26 Q3(b)','19.1'),
    ('9618/43/M/J/26 Q3(c)','19.1'),('9618/43/M/J/26 Q3(d)(i)','19.1'),
    ('9618/43/M/J/26 Q3(d)(ii)','19.1'),
    ('9618/43/M/J/26 Q3(e)(i)','19.2'),('9618/43/M/J/26 Q3(e)(ii)','19.2'),('9618/43/M/J/26 Q3(e)(iii)','19.2')
), p AS (
  SELECT qp.id,qp.syllabus_id
  FROM public.source_papers qp
  JOIN public.syllabi sy ON sy.id=qp.syllabus_id
...
SELECT question_id,subtopic_id,true,1.0,1.0,'manual-source-audit-0188'
FROM r
ON CONFLICT(question_id,subtopic_id)
DO UPDATE SET is_primary=true,weight=1.0,confidence=1.0,set_by='manual-source-audit-0188';

DO $$
DECLARE
  v_qp uuid; v_history int; v_edges int; v_primary int; v_low_p int; v_low_lo int;
  v_sort int; v_file int; v_tree_insert int; v_recur int;
BEGIN
  ...
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp
    AND q.display_ref IN ('9618/43/M/J/26 Q1(f)(i)','9618/43/M/J/26 Q1(f)(ii)','9618/43/M/J/26 Q1(f)(iii)')
    AND lo.code='19.1.2';
  ...
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp AND q.display_ref='9618/43/M/J/26 Q2(b)'
    AND lo.code IN ('20.2.1','20.2.4');

  SELECT count(*) INTO v_tree_insert
  FROM public.questions q
  JOIN public.question_learning_objectives qlo ON qlo.question_id=q.id AND qlo.confidence=1.0
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp
    AND q.display_ref IN ('9618/43/M/J/26 Q3(b)','9618/43/M/J/26 Q3(d)(i)','9618/43/M/J/26 Q3(d)(ii)')
    AND lo.code='19.1.3';
  ...
  JOIN public.learning_objectives lo ON lo.id=qlo.lo_id
  WHERE q.source_paper_id=v_qp
    AND q.display_ref IN ('9618/43/M/J/26 Q3(e)(i)','9618/43/M/J/26 Q3(e)(ii)','9618/43/M/J/26 Q3(e)(iii)')
    AND st.code='19.2' AND lo.code='19.2.1';

  IF v_history<>25 OR v_edges<>26 OR v_primary<>25 OR v_low_p<>0 OR v_low_lo<>0
     OR v_sort<>3 OR v_file<>2 OR v_tree_insert<>3 OR v_recur<>3 THEN
    RAISE EXCEPTION
      '0188 closure failed history=% edges=% primary=% low_primary=% low_lo=% sort=% file=% tree_insert=% recur=%',
      v_history,v_edges,v_primary,v_low_p,v_low_lo,v_sort,v_file,v_tree_insert,v_recur;
  END IF;
END $$;
