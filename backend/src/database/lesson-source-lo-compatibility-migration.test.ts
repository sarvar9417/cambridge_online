...
const sql=readFileSync(new URL('./migrations/0133_lesson_source_lo_compatibility_completion.sql',import.meta.url),'utf8');

describe('0133 lesson-source LO compatibility completion',()=>{
  it('completes the missing 9618 Chapter 1 and 13 current-to-historical edges',()=>{
    ...
    expect(sql).toContain('lesson-source-compatibility-0133');
  });
  ...
  it('does not map historical solution-effectiveness into current algorithm writing',()=>{
