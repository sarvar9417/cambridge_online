...
const sql=readFileSync(new URL('./migrations/0122_lesson_source_lo_compatibility_completion.sql',import.meta.url),'utf8');

describe('0122 lesson-source LO compatibility completion',()=>{
