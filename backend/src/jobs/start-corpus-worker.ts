import{pool}from'../database/client.js';import{config}from'../config.js';import{ClaudeIngestionClient}from'../lib/ai/claude.js';import{loadCorpusReadiness}from'./corpus-readiness.js';import{JobRunner}from'./runner.js';import{createExportPdfProcessor}from'./processors/export-pdf.js';import{createIngestionProcessors}from'./processors/ingestion.js';import{createAiIngestionHandlers}from'./processors/ai-ingestion.js';import{createQuestionExtractionV2Handler}from'./processors/ai-extract-qp-v2.js';import{createAiClassifyV2Handler}from'./processors/ai-classify-v2.js';import{createAiCrossCheckHandler}from'./processors/ai-crosscheck.js';import{validateAssetMetadataStage}from'./processors/asset-metadata.js';import{matchLeafMarkSchemesStage}from'./processors/match-leaves.js';import{createPersistPaperHandler}from'./processors/persist-paper.js';
