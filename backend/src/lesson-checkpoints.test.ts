...
describe('LessonCheckpointService',()=>{
  it('resolves current target LOs through explicit same-qualification compatibility',async()=>{
    const query=vi.fn().mockResolvedValue({rows:[{
      id:'q1',display_ref:'9618/31/M/J/24 Q1(a)',stem:'Question',context_md:'Context',command_word:'Explain',marks:2,
      year:2024,series:'MJ',variant:1,component:3,matched_lo_codes:['13.2-lo-04'],has_diagram:false,has_dependency:true,
    }]});
